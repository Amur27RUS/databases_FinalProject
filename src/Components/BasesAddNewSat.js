            ...
            <div className="piece output">
                ...
                <Button variant="outlined" color="secondary" onClick={() =>{
                    if(selectedGroup !== -1 && selectedName !== -1){
                        ...
                        axios.post('https://dyson3.herokuapp.com/satellite/add', {base_id: baseID.baseId, group_id: selectedGroup, energy_amount: 11, status: 'not active', name: selectedName, lifetime: 11}).then(res =>{
                            if(res.status === 200){
                                setRedirect(true);
                            }
                        })
