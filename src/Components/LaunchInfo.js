        ...
        <div>
            <div className="piece output">
                ...
                <Button variant="outlined" color="secondary" onClick={()=>{
                    axios.post('https://dyson3.herokuapp.com/launch/delete', {id: launchId.launchId, date: launch.date, satelliteId: launch.satelliteId, baseId: launch.baseId, groupId: launch.groupId}).then(res => {
                        if(res.status === 200){
                            setRedirect(true);
                        }
                    })
